...
export default function RegisterStep1Screen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert(
        "¡Solicitud enviada!",
        "La empresa revisará tus datos y, si sos aprobado, vas a recibir un email con el código para completar el registro.",
            ...
            >
              {loading ? (
                ...
                <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
                  <MaterialIcons name="send" size={20} color="#1A1A2E" />
...
const styles = StyleSheet.create({
  ...
  submitButtonText: { color: "#1A1A2E", fontSize: 17, fontWeight: "700" },
