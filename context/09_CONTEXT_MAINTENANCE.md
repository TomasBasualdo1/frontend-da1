...
| `Swagger_v5.YAML` | Contrato OpenAPI 3.0 | **Conservado** — fuente de verdad de la API |
...
2. **Material de valor conservado en su lugar**: `consignas.md`, `Swagger_v5.YAML`, el `.sql`, `progress-tracker.md` y `specs/` **no se tocaron**. Son fuentes de verdad o historia útil; los docs nuevos los enlazan en vez de duplicarlos.
...
├── Swagger_v5.YAML             # (conservado) contrato API
